...
# 
# Function to set up model runs based on specified scenarios (incidence, vaccine schedule) under fast-waning assumptions
#
...
run_simulations_parallel <- function(p,scene,arch){
  ...
  source(here("typhoid_ode_fast_waning.R"))                              # The ODE
  ...
  omegav0_1 = search_grid[p,'omegav0']    # get the stochastic parameter sample for duration of vax protection @ 0-<2yr from the search grid for simulation # p
  omegav0_2 = search_grid[p,'omegav0']    # get the stochastic parameter sample for duration of vax protection @ 0-<2yr from the search grid for simulation # p
  omegav1_1 = search_grid[p,'omegav1']    # get the stochastic parameter sample for duration of vax protection @ 2-<5yr from the search grid for simulation # p
  omegav1_2 = search_grid[p,'omegav1']    # get the stochastic parameter sample for duration of vax protection @ 2-<5yr from the search grid for simulation # p
  omegav2_1 = search_grid[p,'omegav2']    # get the stochastic parameter sample for duration of vax protection @ 5+yr from the search grid for simulation # p
  omegav2_2 = search_grid[p,'omegav2']    # get the stochastic parameter sample for duration of vax protection @ 5+yr from the search grid for simulation # p
  ...
  results <- as.data.frame(ode(y = y0,                 # starting population for each age group/compartment
                               ...
                               func = typhoid_ode_fast, # ODE function to be called by the solver
